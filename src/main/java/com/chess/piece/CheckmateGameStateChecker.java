...
import com.chess.GameState;
import com.chess.GameStateChecker;
    ...
    public GameState check(Board board, Color color) {
       ...
       for (Piece piece : pieces) {
        ...
        for (Coordinates coordinates : availableMoveSquares) {
            ...
            Piece clonedKing = board.getPiecesByColor(color).stream().filter(p -> piece instanceof King).findFirst().get(); 
